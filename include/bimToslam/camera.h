...
#ifndef BIMTOSLAM_CAMERA_H
#define BIMTOSLAM_CAMERA_H
...
class Camera {
   public:
    ...
    double fx_ = 0, fy_ = 0, cx_ = 0, cy_ = 0,
           baseline_ = 0, fb_ = 0;  // Camera intrinsics
    ...
    Camera(double fx, double fy, double cx, double cy, double fb)
        : fx_(fx), fy_(fy), cx_(cx), cy_(cy), fb_(fb) {}
